...
/*************************************************************************************
  ...
  14.6.2017  dusjagr, version 2.1  adding more pre-sets
...
void loop()
{
  ...
  setColorAllPixel(Wheel(240-(selector*30)));
  ...
  while (1)
  {
    ...
    if (getButton() == 1)
    {
      ...
      pixels.setPixelColor(selector - 1, pixels.Color(200, selector*120, 180-selector*70));
      pixels.show(); // This sends the updated pixel color to the hardware.
    ...
    if (getButton() == 2)
    {
      ...
      setColorAllPixel(Wheel(240-((selector-1)*220)));
      pixels.setPixelColor(selector - 1, pixels.Color(0, 190, 0));
